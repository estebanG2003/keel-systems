...
export const content = {
  en: {
    ...
    triggers: [
      ...
      'There is a list of people who asked about us and we never got back to any of them.',
      'We send the quote and then just hope.',
      'I retype the same information into three different places.',
      'I answer the same five questions ten times a day.',
      'To know how the week went I have to open four different things.',
    ],
  ...
  fr: {
    ...
    triggers: [
      ...
      "J'ai une liste de gens qui nous ont demandé des informations et on n'est jamais revenus vers eux.",
      'On envoie la soumission et après on espère.',
      'Je retape la même information à trois endroits différents.',
      'Je réponds aux cinq mêmes questions dix fois par jour.',
      "Pour savoir comment la semaine s'est passée, je dois ouvrir quatre affaires différentes.",
    ],
  ...
  es: {
    ...
    triggers: [
      ...
      'Tengo una lista de gente que preguntó por nosotros y nunca les respondimos.',
      'Mandamos la cotización y de ahí solo esperamos.',
      'Escribo la misma información en tres lugares distintos.',
      'Contesto las mismas cinco preguntas diez veces al día.',
      'Para saber cómo fue la semana tengo que abrir cuatro cosas diferentes.',
    ],
